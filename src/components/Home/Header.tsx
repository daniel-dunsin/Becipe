...
const Header = () => {
  return (
    <section className="w-[90%] max-w-[850px] mx-auto bg-white rounded-xl shadow-lg flex md:flex-row flex-col-reverse overflow-hidden">
      ...
      <div className="flex-[.4] overflow-hidden">
        <img
          ...
          alt=""
          loading="lazy"
          className="md:h-full w-full h-[200px] object-cover object-center hover:scale-[1.3] hover:rotate-[9deg] transition duration-500"
        />
      </div>
    </section>
  );
